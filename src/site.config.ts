...
const config: SiteConfig = {
  ...
  site: 'https://scottbouloutian.com',
  // The name of your site, used in the title and for SEO.
  title: 'Scott Bouloutian',
  // The description of your site, used for SEO and RSS feed.
  description:
    'A developer\'s blog about web development, STEM, and cats. Exploring ideas that sit at the intersection of code and curiosity.',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'Scott Bouloutian',
  // Keywords for SEO, used in the meta tags.
  tags: ['Astro', 'Terminal', 'Theme', 'MultiTerm', 'scottbouloutian'],
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/ScottBouloutian/multiterm-astro',
      external: true,
    },
  ],
  ...
  socialLinks: {
    github: 'https://github.com/ScottBouloutian',
    email: 'scott@bouloutian.com',
    linkedin: 'https://www.linkedin.com/in/scott-bouloutian',
